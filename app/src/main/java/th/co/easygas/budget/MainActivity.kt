...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun setUser(){
        ...
        val image = navHeader.findViewById<ImageView>(R.id.nav_header_image)
        val name = navHeader.findViewById<TextView>(R.id.nav_header_name)
        val email = navHeader.findViewById<TextView>(R.id.nav_header_email)
        ...
        Glide.with(applicationContext)
                .load(getString(R.string.mock_userPicUri))
